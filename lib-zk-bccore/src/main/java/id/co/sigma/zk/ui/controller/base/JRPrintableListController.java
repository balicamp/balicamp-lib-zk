...
/**
 * Base simple list controller with Jasper Report printable feature
 * @author <a href="mailto:ida.suartama@sigma.co.id">Goesde Rai</a>
 */

@org.springframework.stereotype.Component
public abstract class JRPrintableListController<DATA extends Serializable> extends BaseHaveListboxController<DATA> {

	private static final long serialVersionUID = 7617971583358271774L;

	private Logger logger = LoggerFactory.getLogger(JRPrintableListController.class);
