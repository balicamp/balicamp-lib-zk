...
//						e.printStackTrace();
    ...
    private List<ListOfValueItem> loadListOfValueItems(final RptDocParam param, String... dependencyFilter) {
        List<ListOfValueItem> list = new ArrayList<ListOfValueItem>();
