...
public class UserDelegationListController extends BaseSimpleListController<UserDelegation> implements IReloadablePanel {
    ...
    static final org.slf4j.Logger logger = org.slf4j.LoggerFactory
	    .getLogger(UserDelegationListController.class.getName());
	...
	txtStartDateBegin.setValue(null);
	txtStartDateEnd.setValue(null);
	txtEndDateBegin.setValue(null);
	txtEndDateEnd.setValue(null);
    }

    @Override
    protected SimpleQueryFilter[] generateFilters() {
	List<SimpleQueryFilter> myFilters = new ArrayList<>();
	SimpleQueryFilter[] filters = super.generateFilters();
